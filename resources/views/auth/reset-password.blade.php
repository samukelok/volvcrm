...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <!-- Security Notice -->
        <div class="bg-blue-50/80 backdrop-blur-xl border border-blue-200 rounded-2xl p-6">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <p class="mt-1 text-sm text-blue-700">
                        After resetting your password, you'll be redirected to the login page to sign in to your account. 
