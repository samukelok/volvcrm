        ...
        <div class="container-fluid">
            ...
            @if (session('success'))
                <div id="success-alert"
                    style="background-color: #d4edda; color: #155724; padding: 10px 15px; border-radius: 5px; margin-bottom: 15px; display: flex; align-items: center; justify-content: space-between; position: relative;">
                    <span>{{ session('success') }}</span>
                    <button onclick="document.getElementById('success-alert').style.display='none'"
                        style="background: none; border: none; color: #155724; font-weight: bold; font-size: 18px; cursor: pointer;">
                        &times;
                    </button>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Solar Starter</td>
                                    <td><span
                                            class="badge bg-success bg-opacity-10 text-success badge-pill">Converted</span>
                                    </td>
                                    <td>2 hours ago</td>
                                ...
                                <tr>
                                    ...
                                    <td>Premium Solar</td>
                                    <td><span class="badge bg-warning bg-opacity-10 text-warning badge-pill">Pending</span>
                                    </td>
                                    <td>1 day ago</td>
                                    <td><a href="#" class="btn btn-sm btn-outline-primary">View</a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Solar Starter</td>
                                    <td><span class="badge bg-danger bg-opacity-10 text-danger badge-pill">Rejected</span>
                                    </td>
                                    <td>2 days ago</td>
                                    <td><a href="#" class="btn btn-sm btn-outline-primary">View</a></td>
                                </tr>
